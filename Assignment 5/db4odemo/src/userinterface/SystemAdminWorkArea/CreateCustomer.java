...
public class CreateCustomer extends javax.swing.JFrame {
    ...
    CreateCustomer(JPanel userProcessContainer, EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Customer Account create successfully!!", "Info", JOptionPane.INFORMATION_MESSAGE);
        txtName.setText("");
        txtUserName.setText("");
        txtPassword.setText("");
