...
public class CreateCustomer extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (NamePattern() == false) {
            ...
            MainJFrame.system.getCustomerDirectory().getCustomers().add(customer);
            customer.setName(txtName.getText());

            UserAccount ua = MainJFrame.system.getUserAccountDirectory().createUserAccount(txtUserName.getText(), txtPassword.getText(), customer, new CustomerRole());
